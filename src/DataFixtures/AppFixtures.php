...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        // Chargement des informations de l'entité Continent
        ...
        // Chargement des informations de l'entité Famille
        $c1 = new Famille();
        ...
        // Chargement des informations de l'entité Animal
        $a1 = new Animal();
        $a1->setNom("Chien")
